...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        {{-- <h6 class="collapse-header">Các :</h6> --}}
                        <a class="collapse-item" href="/admin/products">Sản phẩm</a>
                        <a class="collapse-item" href="/admin/employee">Nhân viên</a>
                        <a class="collapse-item" href="utilities-animation.html">Hóa đơn</a>
                        <a class="collapse-item" href="utilities-other.html">Khách hàng</a>
                    </div>
                </div>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; DucAnh's Website 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="/assetadmin/js/demo/chart-area-demo.js"></script>
    <script src="/assetadmin/js/demo/chart-pie-demo.js"></script>
