    ...
    @isset($ds)
        ...
        <form action="{{ route('products.search') }}" method="POST"
            ...
            <div class="input-group">
                <input type="text" name="search-data" class="form-control bg-light border-0 small"
                    placeholder="Enter Product's name" aria-label="Search" aria-describedby="basic-addon2">
