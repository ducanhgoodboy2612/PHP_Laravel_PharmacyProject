...
<div class="flexbox" style="width: 100%; height: 100px;margin-top: 20px;">
    ...
    <div class="dropdown custom-dropdown" >
            <a href="#" style="width: 130px;" data-toggle="dropdown" class="dropdown-link" aria-haspopup="true" aria-expanded="false"> <span class="icon-dashboard2 mr-2"></span>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-lg-3 text-center item mb-4">
                ...
                <a href="shop-single.html"> <img src="/assetUser{{$item['Image']}}" alt="Image" style="width: 75%"></a>
                <h3 class="text-dark"><a href="/user/{{$item['Product_Id']}}/detail"
                        style="font-size: 22px; font-weight: lighter; font-family: 'Roboto', sans-serif;">{{$item['Product_Name']}}</a>
                </h3>
