    ...
    @isset($ds)
        ...
        <div class="site-section">
            <div class="container">
                ...
                <div class="row">
                    <img src="/assetUser/img/service.jpg" alt="" style="width: 100%">
                </div>
                <div class="text-center mx-auto mb-5" style="max-width: 700px; padding-top: 100px">
                    <h1 class="display-4">Sản phẩm nổi bật</h1>

                </div>
                <div class="row">
                    <img src="/assetUser/img/hotsale.jpg" alt="" style="width: 100%; margin-bottom: 30px">
                </div>
                <div class="row">
                    ...
                    <div class="d-block card-footer" style="margin-left: 60%">
                        {{ $ds->links('pagination::bootstrap-5', ['show_prev_next' => false]) }}
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                <div class="text-center mx-auto mb-5" style="max-width: 700px;">
                    ...
                    <p>Thuốc bán chạy nhất của MediLife</p>
                </div>
                <div class="row g-4">
                    <div class="col-lg-6 col-xl-4" ">
                                <div class="p-4 rounded bg-light"  style="border: 1px solid green">
                                    <div class="row align-items-center" style="background-color: white;">
                                        <div class="col-6">
                                            <img src="/assetUser/img/medicine/5.3.dauTramCungDinh.jpg" class="img-fluid rounded-circle w-100" alt="">
                                        </div>
                                        <div class="col-6" style="padding-top: 20px">
                                            <a href="#" class="h5">Kem nghệ Decumar</a>
                                            <div class="d-flex my-3">
                                                <i class="fas fa-star" style="color: #5BC2AE"></i>
                                                <i class="fas fa-star" style="color: #5BC2AE"></i>
                                                <i class="fas fa-star" style="color: #5BC2AE"></i>
                                                <i class="fas fa-star" style="color: #5BC2AE"></i>
                                                <i class="fas fa-star" style="color: #5BC2AE"></i>
                                            </div>
                                            <h4 class="mb-3 low-weight-text">305.000 đ</h4>
                                            {{-- <a href="#" class="btn border border-secondary rounded-pill px-3 "><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a> --}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                             <div class="col-lg-6 col-xl-4" ">
                        <div class="p-4 best-seller rounded bg-light" style="border: 1px solid green">
                            <div class="row align-items-center" style="background-color: white;">
                                <div class="col-6">
                                    <img src="/assetUser/img/medicine/6.4. siroat.jpg" class="img-fluid rounded-circle w-100"
                                        alt="">
                                </div>
                                <div class="col-6" style="padding-top: 20px">
                                    <a href="#" class="h5">Kem nghệ Decumar</a>
                    ...
                    <div class="col-lg-6 col-xl-4" ">
                                <div class="p-4 rounded bg-light" style="border: 1px solid green">
                                    <div class="row align-items-center" style="background-color: white;">
                                        <div class="col-6">
                                            <img src="/assetUser/img/medicine/antibio.jpg" class="img-fluid rounded-circle w-100" alt="">
                                        </div>
                                        <div class="col-6" style="padding-top: 20px">
                                            <a href="#" class="h5">Kem nghệ Decumar</a>
                                            <div class="d-flex my-3">
                        ...
                        <div class="p-4 rounded bg-light" style="border: 1px solid green">
                            <div class="row align-items-center" style="background-color: white;">
                                <div class="col-6">
                                    <img src="/assetUser/img/medicine/decumar.jpg" class="img-fluid rounded-circle w-100"
                                        alt="">
                                </div>
                                <div class="col-6" style="padding-top: 20px">
                                    <a href="#" class="h5">Kem nghệ Decumar</a>
                    ...
                    <div class="col-lg-6 col-xl-4" ">
                                <div class="p-4 rounded bg-light" style="border: 1px solid green">
                                    <div class="row align-items-center" style="background-color: white;">
                                        <div class="col-6">
                                            <img src="/assetUser/img/medicine/decumar.jpg" class="img-fluid rounded-circle w-100" alt="">
                                        </div>
                                        <div class="col-6" style="padding-top: 20px">
                                            <a href="#" class="h5">Kem nghệ Decumar</a>
                                            <div class="d-flex my-3">
                                                <i class="fas fa-star" style="color: #5"></i>
                                                <i class="fas fa-star" style="color: #5BC2AE"></i>
                                                <i class="fas fa-star" style="color: #5BC2AE"></i>
                                                <i class="fas fa-star" style="color: #5BC2AE"></i>
                                                <i class="fas fa-star" style="color: #5BC2AE"></i>
                    ...
                    {{-- <div class="col-lg-6 col-xl-4">
                        <div class="p-4 rounded bg-light" style="border: 1px solid green">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <img src="/assetUser/img/decumar.jpg" class="img-fluid rounded-circle w-100" alt="">
                                </div>
                                <div class="col-6">
                                    ...
                                    <h4 class="mb-3 low-weight-text">3.12 $</h4>
